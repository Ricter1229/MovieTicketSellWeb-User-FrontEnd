<template>
    ...
    <main>
        <section class="photos">
            ...
            <CinemaOuterSubPhoto></CinemaOuterSubPhoto>
        </section>

        <section class="cinemas">
            <!-- <section  class="topwrap">
                <section class="regionwrap">
                    <div class="region">北部</div>
                    <div class="region">中部</div>
                    <div class="region">南部</div>
                </section>
                </section>
            ...
            <CinemaOuterAllStores></CinemaOuterAllStores>
        </section>
    </main>
</template>
